...
import {async_get_by_id, async_deletelogic} from "modules/Login/async/async_requests"
...
function LoginDeleteLogic(){
  ...
  const updateform = evt =>{
    ...
    console.log("login.deletelogic.updateform.value",value)
    temp[id] = value
    console.log("login.deletelogic.temp:",temp)
    set_formdata(temp)

    console.log("login.deletelogic.formdata",formdata)
  ...
  const on_submit = async evt => {
    console.log("login.deletelogic.on_submit.formdata:",formdata)
    evt.preventDefault()
    ...
    try {
      ...
      console.log("login.deletelogic.on_submit.r",r)
  ...
  const async_onload = async () => {
    ...
    try {
      ...
      console.log("login.deletelogic.onload.r",r)
      const tmpform = {...formdata, ...r}      
      console.log("login.deletelogic.onload.tmpform",tmpform)
      set_formdata(tmpform)
      if(r.delete_date!=="" && r.delete_date!==null) set_isdeleted(true)
      set_sysdata({...tmpform})
      console.log("login.deletelogic.onload.formdata:",formdata)      
    }
    catch(error){
      set_error(error)
    }
  ...
  useEffect(()=>{
    async_onload()
    return ()=> console.log("login.deletelogic unmounting")
  },[])
  ...
  return (
    <>
      ...
      <main className="container">
        ...
        <h1 className="mt-2 mb-2">login delete log.</h1>
        ...
        <form className="row g-3" onSubmit={on_submit}>
          ...
          <div className="col-12">
            ...
            <input type="text" className="form-control" id="txt-description" placeholder="Name of login" 
...
export default loginDeleteLogic;
