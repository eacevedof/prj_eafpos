...
import {async_get_by_id, async_delete} from "modules/login/async/async_requests"
...
function LoginDelete(){
  ...
  const on_submit = async (evt)=>{
    console.log("login.delete.on_submit.formdata:",formdata)
    evt.preventDefault()
    ...
    try {
      ...
      console.log("login.delete.on_submit.r",r)
  ...
  const async_onload = async () => {
    ...
    try {
      ...
      console.log("login.delete.onload.r",r)
      const tmpform = {...formdata, ...r}
      console.log("login.delete.onload.tmpform",tmpform)
      set_formdata(tmpform)
      if(is_empty(r)){
        set_error("login not found")
        set_isdeleted(true)
      }
    } 
    catch (error) {
      ...
      console.log("login.delete.onload.formdata:",formdata)
      set_issubmitting(false)      
    }
  }
  ...
  useEffect(()=>{
    async_onload()
    return ()=> console.log("login.delete unmounting")
  },[])
  ...
  return (
    <>
      ...
      <main className="container">
        ...
        <h1 className="mt-2 mb-2">login delete</h1>
