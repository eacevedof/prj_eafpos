...
export const VIEWCONFIG = {
  ...
  CACHE_KEY: "logins.search",
  
  PERPAGE: 25,
  
  KEYFIELD: "id",
  
  URL_PAGINATION: "/admin/Logins/%page%",
  
  ACTIONS: {
    //hay que aplicar texto e iconos
    detail: {url:"/admin/Login/%key%", icon:"fa fa-info-circle", text:"Detail"},
    update: {url:"/admin/Login/update/%key%", icon:"fa fa-pencil", text:"Update"},
    delete: {url:"/admin/Login/delete/%key%", icon:"fa fa-trash", text:"Delete"},
    deletelogic: {url:"/admin/Login/delete-logic/%key%", icon:"fa fa-trash", text:"Delete L"},
    clone: {url:"/admin/Login/clone/%key%", icon:"fa fa-files-o", text:"Clone"}, 
  },
