...
export const VIEWCONFIG = {
  ...
  URL_PAGINATION: "/admin/tables/%page%",
  
  ACTIONS: {
    //hay que aplicar texto e iconos
    detail: {url:"/admin/table/%key%", icon:"fa fa-info-circle", text:"Detail"},
    update: {url:"/admin/table/update/%key%", icon:"fa fa-pencil", text:"Update"},
    delete: {url:"/admin/table/delete/%key%", icon:"fa fa-trash", text:"Delete"},
    deletelogic: {url:"/admin/table/delete-logic/%key%", icon:"fa fa-trash", text:"Delete L"},
    clone: {url:"/admin/table/clone/%key%", icon:"fa fa-files-o", text:"Clone"}, 
  },
