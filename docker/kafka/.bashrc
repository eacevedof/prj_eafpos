...
alias consumer-test="kafka-console-consumer.sh --topic test --from-beginning --bootstrap-server kafka_kafka_1:9092"
alias producer-test="kafka-console-producer.sh --topic test --broker-list kafka_kafka_1:9092"
